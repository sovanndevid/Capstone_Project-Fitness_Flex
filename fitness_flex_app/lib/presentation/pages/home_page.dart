                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (!snapshot.hasData || snapshot.hasError) {
                        return const Text('Unable to load today\'s nutrition', style: TextStyle(color: Colors.redAccent));
                      }
                          ...
                          _FormCheckCard(
                            ...
                            onOpen: () {
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (_) => FormCheckCameraPage(cameras: _cameras!),
                                ),
                              );
                            },
                          ),
          ...
          const SizedBox(width: 18),
            Expanded(
              child: Column(
                ...
                children: [
                  Text('Daily Calories', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w700, color: Colors.black)),
...
// Add safe extension for NutritionGoal to provide expected getters
...
class _FormCheckCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget inner;
    if (hasError) {
      inner = const Center(child: Text('Camera unavailable', style: TextStyle(color: Colors.red)));
      ...
      inner = Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Form Check\nRecord or view your exercise form.',
              style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w600, color: Colors.black),
            ),
          ),
    ...
    return InkWell(
      onTap: (cameras != null && cameras!.isNotEmpty && !hasError) ? onOpen : null,
      borderRadius: BorderRadius.circular(22),
      child: Container(
