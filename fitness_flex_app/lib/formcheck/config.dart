class FCConfig {
  ...
  final int savgolWindow; // kept for parity with python
  final int savgolPoly;

  final Map<String, double> scoringWeights;
  final Map<String, double> sideViewWeights;

  // knee_standing_deg, knee_bottom_deg, torso_lean_ok_deg[], valgus_max_drop_pct
  final Map<String, dynamic> thresholds;
  // bottleneck_mix, hard_caps{}, cap_score
  ...
  factory FCConfig.defaultSquat() => FCConfig(
        ...
        thresholds: const {
          ...
          "knee_bottom_deg": 115, // if reps don’t fire, try 120 to sanity-check
